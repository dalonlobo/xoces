...
var tracks = [
  {id: 't1', type: 'program', name: 'Command'},
  {id: 't2', type: 'program', name: 'Science'},
  {id: 't3', type: 'program', name: 'Engineering'},
];

var institutions = [
  {id: 'Starfleet-Academy', type: 'institution', name: 'Program'}
];
...
var cw = xoces.widgets.XocesWidget.new({
  hierarchy: ['institution', 'program', 'module', 'outcome'],
  data: {
